...
'''
On my version the order between bool() and int() matters as python interpret True and False as int. If we don't want to care about the order we cannot do it with a match case (at least I did not find a way but with a different function 
